...
- 🔲 **Branded auth + reminder emails** (confirmation, password reset,
  feedback-checkpoint reminders - scope widened 2026-09-24) - blocked
  on custom SMTP (§1). Confirmation copy drafted: subject "Confirm your
  SporeDesk account," body opens "Thanks for signing up for SporeDesk
  beta." Reset and reminder copy not drafted.
